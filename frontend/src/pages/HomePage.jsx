        ...
        <div className="home-panel">
          ...
          <div className="current-program-panel">
            ...
            <div className="live-video-wrap">
              ...
              {!cameraStreamActive && <img src="/live-placeholder.svg" alt="视频直播窗口占位图" className="live-video-image" />}
              <img
                src="/v1/live/camera-stream"
                alt="手机摄像头实时回传画面"
                className={`live-video-image ${cameraStreamActive ? '' : 'live-video-image-hidden'}`}
                onLoad={() => {
